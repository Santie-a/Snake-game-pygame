...
class Game:
    def __init__(self):
        ...
        self.snake = Snake(self.surface, 40)
        self.snake.draw()
    ...
    def play(self):
        ...
        if self.out_screen(self.snake.x[0], self.snake.y[0]):
            self.play_sound('crash')
            raise 'Game over'
    ...
    def show_game_over(self):
        ...
        line_2 = font.render('Press enter to play again. To exit press Escape', True, (255, 255, 255))
